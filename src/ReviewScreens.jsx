...
import { promptStrategy, promptMix } from './data.js'
  ...
  return (
    <div className="view strategy">
      <div className="strategy-head">
        <div>
          <h2>Prompt Strategy Review — Recommended</h2>
          <p className="sub">Recommended prompt strategy from the approved brand strategy and context.</p>
        </div>
      ...
      <div className="rv-card">
        <div className="card-head"><span className="card-title">Recommended Prompt Strategy</span></div>
...
export function PromptMixPlanReview({ onBack, onContinue }) {
  return (
    <div className="view mix">
      <h2>Prompt Mix Plan Review — Recommended</h2>
